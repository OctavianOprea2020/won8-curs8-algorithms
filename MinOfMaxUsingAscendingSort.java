...
public class MinOfMaxUsingAscendingSort {
    public static void main(String[] args) {
        ...
        a1.add(9);
        a1.add(3);
        Collections.sort(a1); // sort a1 ascending
        ...
        a2.add(4);
        a2.add(80);
        Collections.sort(a2); // sort a2 ascending
        ...
        a3.add(25);
        a3.add(99);
        Collections.sort(a3); // sort a3 ascending
        ...
        a4.add(50);
        a4.add(33);
        Collections.sort(a4); // sort a4 ascending
        ...
        // Because each line is sorted ascending, on the last position is the max from that line
        ...
        for (int i = 0; i < aList.size(); i++) { // line
            maxLine = aList.get(i).get(aList.get(i).size()-1); // maxLine will be initialized with the last value from the line
            if (i == 0) { // first line
